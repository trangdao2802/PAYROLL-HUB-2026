              ...
              {showFooter && (
                ...
                >
                  ...
                  >
                    ...
                    {(() => {
                      const firstNumericColIdx = visibleColumns.findIndex((col: any) => {
                        return footerTotals[col.key] !== null && footerTotals[col.key] !== undefined;
                      });
                      ...
                      return visibleColumns.map((col: any, cIdx: number) => {
                        ...
                        return (
                          <td
                            ...
                            className={`whitespace-nowrap font-bold border-b border-t border-[var(--table-border-color,#e7dbdc)] border-r-0 border-l-0 ${isFirstDataCol ? "text-left pl-3" : getAlignment(col)} uppercase text-[0.75rem] ${footerClassName || "bg-[var(--table-column-header-bg,#F4ECD8)]"} ${(footerClassName || "").includes("text-") ? "" : "text-[var(--table-column-header-text-color,inherit)]"} ${col.footerClassName || ""}`}
                            style={{
